...
// function totalColomn() {
//   for (let i=0;i<5;i++){
//     let lastcolomn= document.createElement('tr');
//     let td= document.createElement('td');
//       td.textContent='totalss';
//       lastcolomn.appendChild(td);
//       table.appendChild(lastcolomn);  
//   }
// }
// totalColomn();
...
// td.innerText='affjg';
// TABLE.innerText='utiugu';
// header.innerText='yuglk';
// TABLE.appendChild(th);
// tr.appendChild(td);
...
//     let avgrandcus = Math.floor(Math.random() * (this.max - this.min + 1) + this.min);
//     return avgrandcus; 
//   },
//   cookieAvg: function () { 
//     let cookAvg = Math.floor(this.avg * this.randomGenerator());
//     console.log(cookAvg);
//     return cookAvg;
//   }, 
//   render: function () {
...
//       this.sale.push(this.cookieAvg());
//       let tag = document.createElement('li');
//       let avg1 = this.cookieAvg();
//       tag.innerHTML = this.hours[i] + avg1;
//       total=total+ avg1;
//       list.appendChild(tag);
//       console.log(this.hours[i] + this.cookieAvg()); 
//     }
//     let totalelement = document.createElement('li');
//     totalelement.innerHTML="total = " + total;
//     head.innerHTML = this.location;
...
// } 
//   getData:function(){
//       let customer1 =this.hours[0]+ randomCus;
//       let customer2 =this.hours[1]+ randomCus;
//       let customer3 =this.hours[2]+ randomCus;
//       let customer4 =this.hours[3]+ randomCus;
//       let customer5 =this.hours[4]+ randomCus;
//       let customer6 =this.hours[5]+ randomCus;
//       let customer7 =this.hours[6]+ randomCus;
//       let customer8 =this.hours[7]+ randomCus;
//       let customer9 =this.hours[8]+ randomCus;
//       let customer10 =this.hours[9]+ randomCus;
//       let customer11 =this.hours[10]+ randomCus;
//       let customer12 =this.hours[11]+ randomCus;
//       let customer13 =this.hours[12]+ randomCus;
//       let customer14 =this.hours[13]+ randomCus;
//       let customer15 =this.hours[14]+ randomCus; 
//   },
//   let main=document.getElementById('demo');
...
//   b.innerText=customer1;
//   c.innerText=customer2;
//   d.innerText=customer3;
//   e.innerText=customer4;
//   f.innerText=customer5;
//   g.innerText=customer6;
//   h.innerText=customer7;
//   i.innerText=customer8;
//   j.innerText=customer9;
//   k.innerText=customer10;
//   l.innerText=customer11;
//   m.innerText=customer12;
//   n.innerText=customer13;
//   o.innerText=customer14;
//   p.innerText=customer15;

//   }
//   list();     
// customerPerHour=randomGenerator(23,65);    
// return customerPerHour;    
// customerPerHour:function(){    
//     let cus = this.saleCus;    
//     cus=random(this.min,this.max);    
// 
//     return cus;    
// },    
// avgcus: function(){    
//     return this.customerPerHour() * this.avg;    
// }     
// };